...
export default function ESklPage() {
  ...
  return (
    <div className="min-h-[100dvh] w-full relative flex flex-col items-center p-4 pt-8 pb-24 overflow-x-hidden overflow-y-auto" style={{ background: "linear-gradient(135deg, #050812 0%, #0a1128 50%, #050812 100%)" }}>
      {/* Orbs */}
